...
class OperationInvoicesControllerTest < ActionController::TestCase
  ...
  def test_should_post_create
    ...
    assert_difference 'OperationObject.count', 1 do
      compatible_request :post, :create, :operation_id => 1,
                                         :operation_object => { :operationable_id => 1 }
    end
  ...
  def test_should_post_create_xhr
    @request.session[:user_id] = 1
    assert_difference 'OperationObject.count', 1 do
      compatible_xhr_request :post, :create, :operation_id => 1, :operation_object => { :operationable_id => 1 }
    end
  ...
  def test_should_destroy
    ...
    assert_difference 'OperationObject.count', -1 do
      compatible_request :delete, :destroy, :operation_id => 1, :object_id => 1, :id => operation_invoice.id
    end
  ...
  def test_should_destroy_xhr
    ...
    operation_invoice = OperationObject.create(:operation_id => 1, :operationable_id => 1, :operationable_type => 'Invoice')
    assert_difference 'OperationObject.count', -1 do
      compatible_xhr_request :delete, :destroy, :operation_id => 1, :object_id => 1, :id => operation_invoice.id
    end
    assert_response :success
  end
